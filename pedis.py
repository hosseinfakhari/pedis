...
class QueueServer(object):
    def __init__(self, host='127.0.0.1', port=63790, max_clients=1024,
                 use_gevent=True):
        self._host = host
        self._port = port
...
class Client(object):
    def __init__(self, host='127.0.0.1', port=63790, pool_max_age=60):
        self._host = host
        self._port = port
...
def get_option_parser():
    ...
    parser.add_option('-p', '--port', default=63790, dest='port',
...
if __name__ == '__main__':
    ...
    print(' /( \x1b[34m@\x1b[33m >\x1b[32m    ,-.  '
          '\x1b[1;32mPedisDB By: semilanceata '
